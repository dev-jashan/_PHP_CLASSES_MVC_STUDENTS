...
<head>
    ...
    <script src="http://127.0.0.1:8080/php/_PHP_CLASSES_MVC_STUDENTS/assets/js/registerForm.js"></script>
</head>
<body>
    ...
    <div class="wrapper">
        ...
        <nav id="nav">
            ...
            <div id="linksContainer">
                <div id="backBtn">            
                    <li id="back"><a href="http://127.0.0.1:8080/php/_PHP_CLASSES_MVC_STUDENTS/login/index">Back</a></li>
                </div>
            </div>
        </nav>
    </div>