...
<head>
    ...
    <script src="http://127.0.0.1:8080/php/_PHP_CLASSES_MVC_STUDENTS/assets/js/main.js"></script>
    ...
    <div class="wrapper">
        ...
        <nav id="nav">
            ...
            <div id="linksContainer">
                ...
                <div id="indexContainer">
                    <li id="login"><a href="http://127.0.0.1:8080/php/_PHP_CLASSES_MVC_STUDENTS/edituser/index">edit User</a></li>
                </div>
